    ...
    <div className="flex flex-col space-y-3 w-[350px] mx-6 sm:mx-0 max-w-md p-6 rounded-2xl bg-primary">
      {index === 1 ? (
        <>
          ...
          <img src={event.imgUrl} className="pt-8 w-full object-contain box-border" alt={event.imgAlt} />
        </>
      ) : (
        <>
          <img src={event.imgUrl} className="w-full object-contain box-border" alt={event.imgAlt} />
