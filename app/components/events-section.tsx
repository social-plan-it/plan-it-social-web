export default function EventsSection() {
  return (
    <section className="max-w-screen-xl bg-[#E4EFF0]">
      <div className="sm:ml-24 pt-10 pb-20 space-y-3 ">
        <h2 className="text-center sm:text-left sm:text-5xl text-4xl font-bold italic text-[#1F2937]">
          Upcoming Events
        </h2>
        <div className="flex flex-wrap gap-6 justify-center sm:justify-start">
          <div className="flex flex-col w-[350px] mx-6 sm:mx-0 max-w-md p-6 rounded-2xl bg-[#1F2937]">
            <img
              src="upc-events1.png"
              className="w-full object-contain box-border"
              alt="group of people in a meeting"
            />
            <div className="pt-6 text-lg sm:text-2xl font-bold text-white">
              Group Name
            </div>
